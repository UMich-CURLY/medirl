...
class irl():
    ...
    def is_start(self):
        ...
        print("Robot past is ", self.robot_past_traj)
        print("Found policy is ", traj)
    ...
    def people_callback(self, data):
        ...
        for i in range(length):
            self.human_traj.append([human_traj[i][0], human_traj[i][1]])
